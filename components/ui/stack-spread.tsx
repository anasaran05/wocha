...
// Real, high-resolution Unsplash streetwear apparel & editorial photography
const IMG = {
  plane: "https://images.unsplash.com/photo-1521572267360-ee0c2909d518?auto=format&fit=crop&w=1000&q=80",
  painting: "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&w=1000&q=80",
  breaker: "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=1000&q=80",
  dog: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=1000&q=80",
  footballer: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?auto=format&fit=crop&w=1000&q=80",
  jacket: "https://images.unsplash.com/photo-1544441893-675973e31985?auto=format&fit=crop&w=1000&q=80",
  meadow: "https://images.unsplash.com/photo-1509967419530-da38b4704bc6?auto=format&fit=crop&w=1000&q=80",
  stripes: "https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=1000&q=80",
} as const;
...
const CARDS: StackSpreadCard[] = [
  ...
  {
    item: { src: IMG.stripes, alt: "Heavyweight Hoodies" },
    stackOffset: { x: -8, y: -4 },
    stackRotate: -18,
  ...
  {
    item: { src: IMG.meadow, alt: "Editorial Streetwear" },
    stackOffset: { x: 12, y: -4 },
    stackRotate: 20,
  ...
  {
    item: { src: IMG.jacket, alt: "Streetwear Outerwear" },
    stackOffset: { x: -14, y: 0 },
    stackRotate: -4,
  ...
  {
    item: { src: IMG.footballer, alt: "Anime Back-Print Series" },
    stackOffset: { x: 2, y: -4 },
    stackRotate: -2,
  ...
  {
    item: { src: IMG.dog, alt: "Acid Wash Drop-Shoulder" },
  ...
  {
    item: { src: IMG.breaker, alt: "Graphic Tee Series" },
    stackOffset: { x: -5, y: 5 },
    stackRotate: 6,
  ...
  {
    item: { src: IMG.painting, alt: "Anime Graphic Art" },
    stackOffset: { x: 6, y: 5 },
    stackRotate: 3,
  ...
  {
    item: { src: IMG.plane, alt: "Drop-Shoulder Heavy T-Shirt" },
    stackOffset: { x: 16, y: 6 },
    stackRotate: -7,
...
const DEFAULT_SUB = "Heavyweight t-shirts, drop-shoulders, and thick hoodies. Built to last.";
...
function CardFace({
  ...
  return (
    <div
      className="relative h-full w-full overflow-hidden max-md:rounded-[4vw] shadow-md border border-black/10"
...
function StackSpreadStage({
  ...
  return (
    <section
      ref={wrapRef}
      className="relative w-full hairline-bottom"
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center pt-16">
        ...
        <motion.div
          className={`absolute inset-0 z-[15] flex flex-col items-center justify-center px-6 text-center max-md:px-8 ${
            spread ? "pointer-events-auto" : "pointer-events-none"
          }`}
          style={{
            opacity: copyOpacity,
        ...
        >
          {headline ? (
            ...
            <h2
              className="w-full whitespace-pre-line text-[4.5vw] font-bold tracking-tight max-md:text-[9vw] leading-tight"
              style={{ color: textColor }}
            >
              Heavyweight Cotton.
              <br />
              <span className="font-light italic text-[#666666]">Made To Last.</span>
            </h2>
          )}
          <p
            className="mt-[1.2vw] w-full max-w-[44ch] text-[1.15vw] leading-relaxed tracking-tight max-md:mt-3 max-md:text-[3.6vw]"
        ...
        {showScrollHint && (
          <motion.div
            className="pointer-events-none absolute inset-x-0 bottom-[4vh] z-20 flex flex-col items-center gap-1.5 text-[0.8vw] font-mono font-medium uppercase tracking-[0.2em] max-md:bottom-6 max-md:text-[2.8vw]"
